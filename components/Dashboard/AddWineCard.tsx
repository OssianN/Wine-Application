...
export const AddWineCard = ({ id }: AddWineCardProps) => {
  ...
  return (
    <Button
      ref={setNodeRef}
      key={id}
      className="h-full min-h-48 rounded-md min-w-32 shadow-sm relative bg-neutral-50  text-neutral-300 dark:text-neutral-500 transition-all duration-300 -outline-offset-4 betterhover:hover:text-neutral-400 dark:bg-neutral-975 dark:betterhover:hover:bg-neutral-900"
      style={{
        gridRow: shelfNumber,
