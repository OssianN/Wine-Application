...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow betterhover:hover:bg-primary/90',
        destructive:
          'bg-destructive text-destructive-foreground shadow-sm betterhover:hover:bg-destructive/90',
        outline:
          'border border-input bg-background shadow-sm betterhover:hover:bg-accent betterhover:hover:text-accent-foreground',
        secondary:
