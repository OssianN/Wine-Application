...
export const wineDto = ({
  ...
  return {
    ...
    drinkingWindowStart: scraping?.drinkingWindowStart ?? null,
    drinkingWindowEnd: scraping?.drinkingWindowEnd ?? null,
    drinkingWindowStatus: scraping?.drinkingWindowStatus ?? null,
    comment,
